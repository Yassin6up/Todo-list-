class Task {
  ...
  constructor(name, taskList) {
    ...
    removeButton.onclick = (btn, ev) => taskList.removeTask(this.#id);
...
// here i wana add script for transition plus btn
// this is var for icone plus
let plus = document.getElementById("plus");
//this is var for btn add
let addBtn = document.getElementById("add");
// this is event for in mouse hover to the btn add => give icone pluse class (active) for rotate the icone to 40deg
